...
class TicketBotTrade(app_commands.Group):
    ...
    ################################### COMMANDS #######################################
    ####################################################################################
    @app_commands(name="accept", description="Accept a user's trade request")
    ...
    @app_commands(name="reject", description="Reject a user's trade request")
    ...
    @app_commands(name="cancel", description="Cancels an existing trade request")
    ...
    @app_commands(name="start", description="Request to trade with another user")
    ...
    @app_commands(name="coinflip", description="Coinflip for tickets with another user")
